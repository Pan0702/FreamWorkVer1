...
PipelineStateBuilder& PipelineStateBuilder::SetDepthWriteEnabled(bool enabled)
{
...
bool PipelineStateBuilder::Build(ID3D12Device* device, PipelineState* out_pipeline_state) const
{
    ...
    //深度
    {
        ...
        desc.DepthStencilState.DepthWriteMask =
            (depth_enable_ && depth_write_) ? D3D12_DEPTH_WRITE_MASK_ALL : D3D12_DEPTH_WRITE_MASK_ZERO;
