...
public:
     ...
     */
    void DrawSprite3D(Texture2D* texture, const Mat& mat, const Vec2& size, const Vec2& src_pos, const Vec2& src_size,
                      float alpha) const;
    /**
    ...
    void DrawTriangle3D(const Vec3& a, const Vec3& b, const Vec3& c, const Vec4& color) const;
